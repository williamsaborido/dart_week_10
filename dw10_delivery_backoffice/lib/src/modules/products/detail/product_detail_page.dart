      ...
      reaction((_) => controller.status, (status) {
        switch (status) {
          ...
          case ProductDetailStateStatus.loaded:
            ...
            nomeController.text = model.name;
            precoController.text = model.price.currencyPTBR;
            descricaoController.text = model.description;
            hideLoader();
            break;
          case ProductDetailStateStatus.error:
            hideLoader();
            showError(controller.errorMessage ?? 'Erro ao salvar produto');
            break;
          case ProductDetailStateStatus.errorLoadProduct:
            hideLoader();
            showError(
              controller.errorMessage ?? 'Erro ao abrir produto para alteração',
            );
