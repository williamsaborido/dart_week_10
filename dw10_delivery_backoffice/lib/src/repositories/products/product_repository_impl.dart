...
class ProductRepositoryImpl implements ProductRepository {
  ...
  Future<void> save(ProductModel productModel) async {
    try {
      ...
      log(
        'Erro ao salvar o produto ${productModel.id}',
        error: e,
        stackTrace: s,
      );
      throw RepositoryException(
        message: 'Erro ao salvar o produto ${productModel.id}',
      );
    }
  }
  ...
  Future<String> uploadImageProduct(Uint8List file, String filename) async {
    try {
      ...
      log('Erro ao fazer upload do arquivo $filename', error: e, stackTrace: s);
      throw RepositoryException(
        message: 'Erro ao fazer upload do arquivo $filename',
      );
    }
  }
}
